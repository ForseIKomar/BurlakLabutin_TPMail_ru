...
public:
	...
	virtual void WhereCanMove(   std::vector</*std::shared_ptr<CCell*/SPoint/*>*/> &potential_cells ) = 0;
	virtual void WhereCanAttack( std::vector</*std::shared_ptr<CCell*/SPoint/*>*/> &potential_cells ) = 0;
